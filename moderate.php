...
//
		function Stats ($minAttack, $maxAttack, $minMAttack, $maxMAttack){
			...
			<form method="POST" action="moderate.php"><br>
			<button type="submit" name="attack" class="btn btn-danger">Attack</button>   or  
